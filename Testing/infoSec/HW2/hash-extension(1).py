...
secret_key = ''.join(random.choice(string.ascii_uppercase) for _ in range(16)).encode()
print(secret_key)
flag = 'sds'


welcome = "Welcome to Secure Flag Storage Service version 1.{}".format(random.randint(0,99))
